...
local NotifyFrame, oldminor, ns = GUI:NewClass(MAJOR, MINOR, 'Button.BackdropTemplate')
...
function NotifyFrame:Constructor()
    ...
    local Close = CreateFrame('Button', nil, self, "BackdropTemplate") do
    ...
    local IgnoreButton = CreateFrame('Button', nil, self, "BackdropTemplate") do
